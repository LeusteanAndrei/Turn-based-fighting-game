...
public class Character {
    ...
    public Character(String name, Stats stats)
    {
        this.name = name;
        this.level = 0;
        this.initial_stats = new Stats(stats);
        this.current_stats = new Stats(stats);
        this.charge = 0;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(name, character.name) && Objects.equals(initial_stats, character.initial_stats) && type == character.type;
    }

    public String quickPrint()
    {
        StringBuilder s = new StringBuilder();
        s.append("Character: ").append(name).append(", level: ").append(level).append("\n");
        return s.toString();
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, initial_stats, type);
    }
}
